""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"
" Maintainer: Jiessie Cao (Jiessie) <jiessie.cao@gmail.com>
" Created: 2012-01-20
...
set modeline " Turn on modeline, for some format
set encoding=utf-8 " Set utf-8 encoding
set completeopt+=longest,menu " Optimize auto complete
...
" for showing indent levels
Bundle 'nathanaelkane/vim-indent-guides'

" only edit for selected part
Bundle 'chrisbra/NrrwRgn'
" a start page for vim
...
" it defines two indent text objects,ai,ii,al,il

Bundle 'michaeljsmith/vim-indent-object'
" it add ic,ac,iC,aC as text-objects for deleting, changing, adding to vertical
" column in visual blocks.
Bundle 'coderifous/textobj-word-column.vim'

" ]<Space> add newlnes before, [<Space> add newlines after the cursor line 
" [e, ]e exchange current line with the one above or below it
" [u, ]u encode and decode URLs
" [y, ]y escaping C string.
Bundle 'tpope/vim-unimpaired'

" automatically split window
Bundle 'zhaocai/GoldenView.Vim'

" ctags and gundo tags
if has('python')
...
" unit search for file, buffers, recent files, regiester
Bundle 'Shougo/unite.vim'

" present filesystem in a tree
Bundle 'scrooloose/nerdtree'

" find file, buffer, MRU files
Bundle 'kien/ctrlp.vim'

" search , like grep, show term in quickfix windown
if executable('ag')
    Bundle 'rking/ag.vim'
...
" cs'" make surround for string from ' to "
" ds" delete surround "
...
nnoremap <Leader>wq :%s/\s\+$//<CR>:let @/=''<CR>
...
" => Syntastic
"--------------------------------------------------
let g:syntastic_ignore_files=[".*\.py$"]   "pylint for python
...
let g:ycm_cache_omnifunc=0  "  forbid cache
let g:ycm_seed_identifiers_with_syntax=1
...
"-----------------------------------------------------------------¬
let g:DoxygenToolkit_authorName="Jiessie - jiessie.cao AT gmail DOT com"
